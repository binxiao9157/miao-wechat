...
export default function JoinFriend() {
  ...
  if (!uid) {
    return (
      <div className="h-dvh bg-[#FFF5F0] flex flex-col items-center justify-center p-6 text-center overflow-y-auto">
  ...
  return (
    <div className="h-dvh bg-[#FFF5F0] flex flex-col items-center justify-center p-6 overflow-y-auto">
      <motion.div
